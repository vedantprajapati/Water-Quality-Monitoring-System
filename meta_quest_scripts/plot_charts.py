...
def vis_matplotlib():
    ...
    draw_scatter(
        ...
        red,
        "r",
        "Temperature vs Turbidity vs Water Pollution Level",
        fig,
        2,
    )
    draw_scatter(
        ...
        red,
        "g",
        "Temperature vs Dissolved Solids vs Water Pollution Level",
        fig,
        3,
    )
    draw_scatter(
        ...
        red,
        "b",
        "Turbidity vs Dissolved Solids vs Water Pollution Level",
        fig,
        4,
    )
